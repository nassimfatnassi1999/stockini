export const PERMISSIONS = {
  ...
  SALES_LINE_EDIT_UNIT_PRICE_HT: 'sales.line.edit_unit_price_ht',
...
export const ALL_PERMISSIONS: PermissionDef[] = [
  ...
  { code: 'sales.line.edit_unit_price_ht', module: 'sales', action: 'line.edit_unit_price_ht', label: 'Modifier PU HT', description: 'Modifier le prix unitaire HT dans les lignes de document commercial' },
